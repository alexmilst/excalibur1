...
const coaches = [
  ...
  },
  {
    ...
    img: "https://i.imgur.com/2yfLFUS.jpeg",
    isLogo: false,
...
const flagshipSaturdaySchedule = [
  { time: "10:30 AM", dur: "40 min", block: "Block 1a — Public Speaking · Opening", instructor: "", role: "Senior Public Speaking Instructor", img: null, desc: "Public speaking is a central discipline in every Excalibur program. Students get on their feet, speak to the room, practice eye contact, strengthen their voice, and learn how to communicate with confidence. The work develops from foundational mechanics into rhetoric, debate, impromptu speaking, persuasive delivery, and pitch preparation. With repeated practice and direct feedback, students build the kind of presence that carries into interviews, presentations, leadership roles, and every room ahead.", color: "#C7AB75" },
  ...
  { time: "2:10 PM", dur: "40 min", block: "Block 3a — War Room · Case Study", instructor: "", role: "Lead Program Director", img: null, desc: "The War Room is where instruction becomes application. Led by senior faculty, this block places students into structured business scenarios that require analysis, decision-making, communication, and teamwork under pressure, rotating through three formats: (1) What Would You Have Done? — students are placed inside real business moments before knowing the outcome, make the call, defend their reasoning, then learn what actually happened; (2) Your Move — students inherit a company in crisis, build a turnaround strategy, and present their decisions to faculty as if pitching a skeptical investor; (3) Apply It Now — the day's specialist content is immediately put to work through live exercises, workshops, and team challenges.", color: "#C7AB75" },
  ...
  { time: "3:00 PM", dur: "40 min", block: "Block 3b — War Room · Applied Workshop", instructor: "", role: "Lead Program Director", img: null, desc: "The War Room is where instruction becomes application. Led by senior faculty, this block places students into structured business scenarios that require analysis, decision-making, communication, and teamwork under pressure, rotating through three formats: (1) What Would You Have Done? — students are placed inside real business moments before knowing the outcome, make the call, defend their reasoning, then learn what actually happened; (2) Your Move — students inherit a company in crisis, build a turnaround strategy, and present their decisions to faculty as if pitching a skeptical investor; (3) Apply It Now — the day's specialist content is immediately put to work through live exercises, workshops, and team challenges.", color: "#C7AB75" },
              ...
              <div key={pi}>
                <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "180px 1fr", background: "#111", borderLeft: `3px solid ${gold}`, marginBottom: 2 }}>
                  <div style={{ padding: isMobile ? "14px 20px" : "18px 24px", borderRight: "1px solid rgba(199,171,117,.08)" }}>
                    ...
                    <p style={{ fontFamily: sans, fontSize: 10, color: "#C7AB75", fontWeight: 300 }}>{phase.span}</p>
                  </div>
      ...
      {[
        ...
        <div key={i} style={{ background: "#080808", padding: "24px 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
            {t.items.map(([k, v]) => (
              <div key={k}>
                <div style={{ fontFamily: "'Avenir','Avenir Next','Century Gothic',sans-serif", fontSize: 9, color: "#C7AB75", marginBottom: 3, letterSpacing: "0.1em", textTransform: "uppercase" }}>{k}</div>
      ...
      <div style={{ padding: "20px 24px 24px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: 320 }}>
        ...
        {hasFacultyPage && (
          <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap", marginTop: 20 }}>
            ...
            {c.linkedin && (
              <a href={c.linkedin} target="_blank" rel="noopener noreferrer" style={{ fontFamily: sans, fontSize: 11, color: "#C7AB75", letterSpacing: "0.08em", fontWeight: 600, textDecoration: "none" }}>LinkedIn ↗</a>
            )}
          </div>
        )}
      </div>
...
function HomePage({ setPage, openInquiry }) {
  ...
  return (
    <div style={{ background: "#000" }}>
      ...
      {/* HERO */}
      <section style={{ minHeight: isMobile ? "auto" : "100vh", display: "flex", flexDirection: "column", justifyContent: "stretch", position: "relative", overflow: "hidden", background: "#000" }}>

        {isMobile ? (
          /* ── MOBILE: photo then content stacked ── */
          <>
            <div style={{ position: "relative", height: 280, overflow: "hidden" }}>
              <img src="https://i.imgur.com/5lWMfOb.jpeg" alt="Excalibur Academy" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top" }} onError={e => e.target.style.display="none"} />
            ...
            <div style={{ padding: "40px 24px 60px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 28, width: "100%", maxWidth: 320 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "100vh" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "80px 64px 80px 80px", position: "relative", zIndex: 1, borderRight: "1px solid rgba(199,171,117,.08)" }}>
              ...
              <Fade d={.10}>
                <p style={{ fontFamily: "'Forum', 'Copperplate', Georgia, serif", fontWeight: 400, fontSize: "clamp(26px,2.4vw,38px)", letterSpacing: "0.28em", color: "#FBF7EE", textTransform: "uppercase", lineHeight: 1, marginBottom: 6, whiteSpace: "nowrap", textAlign: "center" }}>
                  Excalibur Academy
                </p>
                <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(13px,1.1vw,17px)", letterSpacing: "0.22em", color: gold, fontStyle: "italic", marginBottom: 48, textAlign: "center" }}>
              ...
              <Fade d={.14}>
                <div style={{ width: 160, height: "1px", margin: "0 auto 44px", background: `linear-gradient(90deg, transparent, ${gold} 30%, ${gold} 70%, transparent)` }} />
              </Fade>

              {/* Main headings */}
              <Fade d={.20}>
                <h1 style={{ fontFamily: "'Cormorant Garamond', 'Didot', Georgia, serif", fontStyle: "italic", fontSize: "clamp(22px,2.0vw,32px)", fontWeight: 300, lineHeight: 1.35, color: "#FBF7EE", marginBottom: 8, letterSpacing: "0.01em", textAlign: "center" }}>
                  The Future Belongs to Those Who Build It.
                </h1>
                <h1 style={{ fontFamily: "'Cormorant Garamond', 'Didot', Georgia, serif", fontSize: "clamp(26px,2.5vw,40px)", fontWeight: 600, lineHeight: 1.1, color: gold, marginBottom: 36, letterSpacing: "0.01em", textAlign: "center" }}>
                  Become Who You Are.
                </h1>
              </Fade>
            ...
            <div style={{ position: "relative", overflow: "hidden" }}>
              <img src="https://i.imgur.com/5lWMfOb.jpeg" alt="Excalibur Academy" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top" }} onError={e => e.target.style.display="none"} />
              {/* Subtle left-edge fade to blend with black left panel */}
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(0,0,0,.35) 0%, transparent 30%)" }} />
            </div>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 400px", gap: isMobile ? 40 : 80, alignItems: "center" }}>
              ...
              <div>
                ...
                <p style={{ fontFamily: sans, fontSize: isMobile ? 14 : 15, lineHeight: 2.0, color: "#FBF7EE", fontWeight: 300, marginBottom: 24 }}>
                ...
                <p style={{ fontFamily: sans, fontSize: isMobile ? 14 : 15, lineHeight: 2.0, color: "#FBF7EE", fontWeight: 300, marginBottom: 40 }}>
      ...
      <div style={{
        ...
        <div style={{ padding: isMobile ? "32px 28px 20px" : "40px 52px 24px", borderBottom: "1px solid rgba(199,171,117,.08)", position: "sticky", top: 0, background: "#000", zIndex: 1 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <button onClick={onClose} style={{ background: "none", border: "none", color: "#C7AB75", fontSize: 22, cursor: "pointer", lineHeight: 1, marginTop: 4, padding: "4px 8px", transition: "color .2s" }} onMouseEnter={e=>e.target.style.color="#FBF7EE"} onMouseLeave={e=>e.target.style.color="rgba(251,247,238,.4)"}>×</button>
          </div>
          {/* Step indicator */}
          {!submitted && (
...
function SummerDetailPage({ setPage, openInquiry }) {
  ...
  const days = [
    { n: "Day 1", title: "Orientation, Leadership & Team Building", date: "Mon July 27", theme: "What makes leaders persuasive?" },
    ...
    { n: "Day 7", title: "Marketing, Networking & Influence", date: "Tue Aug 4", theme: "Relationships are leverage.", speaker: true },
    { n: "Day 8", title: "Pitch Building & Investor Psychology", date: "Wed Aug 5", theme: "A great idea poorly presented loses." },
    ...
    <div style={{ background: "#000" }}>
      ...
      {isMobile ? (
        <div style={{ background: "#000" }}>
          <div style={{ position: "relative", height: 240, overflow: "hidden" }}>
            ...
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,0,0,.1) 0%, rgba(0,0,0,.7) 100%)" }} />
            <div style={{ position: "absolute", bottom: 24, left: 24 }}>
              <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.42em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 8 }}>Summer Intensive · July 27 – August 8, 2026</p>
              <h1 style={{ fontFamily: serif, fontSize: 30, fontWeight: 300, fontStyle: "italic", color: "#FBF7EE", lineHeight: 1.0 }}>Two Weeks.<br />Real Ventures.</h1>
            </div>
          </div>
          <div style={{ background: "#000", padding: "20px 24px 8px" }}>
            <p style={{ fontFamily: serif, fontSize: 18, color: gold, fontStyle: "italic", fontWeight: 300 }}>Elite Mentorship. Executive Formation.</p>
          </div>
        </div>
      ) : (
        <div style={{ position: "relative", background: "#000", overflow: "hidden", height: 480 }}>
          <img src="https://i.imgur.com/N4OB8dS.jpeg" alt="Summer Intensive" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,.95) 0%, rgba(0,0,0,.1) 60%)" }} />
          <div style={{ position: "absolute", bottom: 64, left: 72 }}>
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.42em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 16 }}>Summer Intensive · Orange County, California · 2026</p>
            <h1 style={{ fontFamily: serif, fontSize: 64, fontWeight: 300, fontStyle: "italic", color: "#FBF7EE", lineHeight: 1.0, marginBottom: 8 }}>Two Weeks.<br />Real Ventures.</h1>
            <p style={{ fontFamily: serif, fontSize: 28, color: gold, fontStyle: "italic", fontWeight: 300 }}>Elite Mentorship. Executive Formation.</p>
          </div>
          <div style={{ position: "absolute", top: 24, left: 24 }}>
            <button onClick={() => setPage("programs")} style={{ fontFamily: sans, background: "rgba(0,0,0,.5)", border: "1px solid rgba(199,171,117,.3)", color: gold, padding: "8px 16px", fontSize: 10, letterSpacing: "0.15em", cursor: "pointer", textTransform: "uppercase" }}>← OUR PROGRAMS</button>
          </div>
      ...
      <div style={{ background: "#F5F3EE", padding: isMobile ? "52px 24px" : "80px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            <div style={{ width: 32, height: "1px", background: "rgba(139,105,20,.4)" }} />
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.45em", color: "#8B6914", fontWeight: 600, textTransform: "uppercase", margin: 0 }}>The Program</p>
          </div>
          <h2 style={{ fontFamily: serif, fontSize: isMobile ? 30 : 48, fontWeight: 300, fontStyle: "italic", color: "#000", lineHeight: 1.05, marginBottom: 32 }}>Not a simulation.<br />Not a case study.</h2>

          {/* Full-width description wrapping around details table */}
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 340px", gap: isMobile ? 32 : 56, alignItems: "start", marginBottom: 48 }}>
            <div>
              <p style={{ fontFamily: sans, fontSize: 15, lineHeight: 2.0, color: "#1a1a1a", fontWeight: 300, marginBottom: 18 }}>The Excalibur Summer Intensive is ten full days of venture development, leadership formation, and real-world execution. Students choose one of two tracks — Frontier, a commercial market venture, or Vanguard, a community impact venture that addresses a real community problem in Orange County — and spend two weeks doing what most adults have never done: identifying a real opportunity, validating it with real people, building something tangible, and defending every decision in front of a live panel of investors and executives.</p>
              <p style={{ fontFamily: sans, fontSize: 15, lineHeight: 2.0, color: "#1a1a1a", fontWeight: 300, marginBottom: 18 }}>Students do not study entrepreneurship from the sidelines or through theory alone. They experience it through execution, decision-making, customer interaction, leadership, and real-world venture building. They build. They test. They sell. They present. From customer discovery and market validation to MVP development, pre-orders, early revenue, and a Shark Tank-inspired Finale before investors, executives, entrepreneurs, and community leaders — every student experiences what it means to move an idea from concept to execution.</p>
              <p style={{ fontFamily: sans, fontSize: 15, lineHeight: 2.0, color: "#1a1a1a", fontWeight: 300, marginBottom: 18 }}>Every day begins with public speaking and executive presence training led by senior faculty. Every afternoon is venture work — customer discovery, MVP development, market testing, and traction generation. Faculty, invited specialists, and C-level mentors are in the room every day, rotating between teams, challenging assumptions, and holding students to a standard they won't encounter anywhere else at this age. Guest speakers — entrepreneurs, executives, and investors — join every other day. On Vanguard track, invited community officials join the Finale panel.</p>
              <p style={{ fontFamily: sans, fontSize: 15, lineHeight: 2.0, color: "#1a1a1a", fontWeight: 300, marginBottom: 18 }}>Every student leaves with a portfolio documenting the full arc of what they built: customer research, market analysis, MVP development, traction evidence, first revenue or pilot commitments, and a recorded pitch before a live panel of entrepreneurs, executives, and investors — alongside letters of recommendation from faculty, specialists, and senior executives, and a certificate of completion. When college admissions officers review what these students accomplished, they will not simply see a summer program. They will see a founder. A leader with proof of initiative, judgment, courage, execution, and leadership.</p>
              <p style={{ fontFamily: sans, fontSize: 15, lineHeight: 2.0, color: "#1a1a1a", fontWeight: 300 }}>For the students themselves, these are two weeks that turn dreams into discipline, and discipline into achievement — discovering how a real venture is built from the ground up, how to lead, how to perform under pressure, how to validate ideas in the real world, how to network with potential partners, acquire first customers, and what becomes possible when they are pushed to think outside the box and understand that impossible is a choice.</p>
            </div>
            <div style={{ position: isMobile ? "static" : "sticky", top: 80 }}>
              <div style={{ background: "#fff", border: "1px solid rgba(0,0,0,.08)", borderTop: "2px solid #8B6914", padding: "28px 24px" }}>
                <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.35em", color: "#8B6914", fontWeight: 600, textTransform: "uppercase", marginBottom: 20 }}>Program Details</p>
                {[["Wave","July 27 – August 8, 2026"],["Schedule","Mon–Fri · 9:30 AM – 4:00 PM"],["Class Size","Limited to 20 students"],["Tuition","$410 / day · $4,500 per wave"],["Ages","14–17 · High school students"],["Location","South Orange County, CA"]].map(([k,v]) => (
                  <div key={k} style={{ display: "grid", gridTemplateColumns: "72px 1fr", gap: 10, padding: "9px 0", borderBottom: "1px solid rgba(0,0,0,.06)" }}>
                    <span style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.15em", color: "#8B6914", textTransform: "uppercase", paddingTop: 3 }}>{k}</span>
                    <span style={{ fontFamily: sans, fontSize: 12, color: "#1a1a1a", fontWeight: 400, lineHeight: 1.55 }}>{v}</span>
                  </div>
                ))}
                <button onClick={() => openInquiry && openInquiry("summer")} style={{ fontFamily: sans, padding: "13px 0", background: "#000", border: "none", color: "#fff", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", cursor: "pointer", width: "100%", marginTop: 20 }}>APPLY NOW →</button>
              </div>
            </div>
          </div>

          {/* What's Included — full width below */}
          <div style={{ background: "#fff", border: "1px solid rgba(0,0,0,.08)", borderTop: "2px solid #000", padding: "28px 28px" }}>
            <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.35em", color: "#8B6914", fontWeight: 600, textTransform: "uppercase", marginBottom: 20 }}>What's Included</p>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 0 }}>
              {["Daily public speaking & executive presence training","Specialist instruction · core curriculum each day","Venture development workshops · customer discovery to MVP","Distinguished guest speakers every other day","Excalibur Venture Finale · Shark Tank-inspired · real investors","Bound certificate of completion & graduate portfolio","Catered lunches, snacks, smoothies & refreshments","Priority consideration for the Ten-Month Flagship Program","Daily Academy Shuttle for South OC students"].map((item, i) => (
                <div key={i} style={{ display: "flex", gap: 10, padding: "9px 0", borderBottom: "1px solid rgba(0,0,0,.05)", alignItems: "flex-start", paddingRight: !isMobile && i % 2 === 0 ? 24 : 0, paddingLeft: !isMobile && i % 2 !== 0 ? 24 : 0, borderLeft: !isMobile && i % 2 !== 0 ? "1px solid rgba(0,0,0,.05)" : "none" }}>
                  <div style={{ width: 5, height: 5, borderRadius: "50%", background: "#8B6914", marginTop: 7, flexShrink: 0 }} />
                  <span style={{ fontFamily: sans, fontSize: 12, color: "#1a1a1a", fontWeight: 300, lineHeight: 1.65 }}>{item}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* STATS STRIP */}
      <div style={{ background: "#000", borderTop: "1px solid rgba(199,171,117,.1)", borderBottom: "1px solid rgba(199,171,117,.1)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : "repeat(4,1fr)", borderLeft: "1px solid rgba(199,171,117,.08)" }}>
          {[["10","Full Program Days"],["20","Students Per Wave"],["2","Venture Tracks"],["4","Distinguished Guest Speakers"]].map(([n,l]) => (
            <div key={l} style={{ padding: isMobile ? "32px 20px" : "44px 36px", borderRight: "1px solid rgba(199,171,117,.08)", borderBottom: isMobile ? "1px solid rgba(199,171,117,.08)" : "none" }}>
              <p style={{ fontFamily: serif, fontSize: isMobile ? 40 : 52, fontWeight: 300, color: gold, lineHeight: 1, marginBottom: 10 }}>{n}</p>
              <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.25em", color: "#FBF7EE", textTransform: "uppercase", fontWeight: 400 }}>{l}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ background: "#F5F3EE", padding: isMobile ? "52px 24px" : "80px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 16 }}>
            {/* Track A - Frontier */}
            <div style={{ background: "#fff", border: "0.5px solid rgba(0,0,0,.1)", padding: isMobile ? "32px 24px" : "44px 40px" }}>
              <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.4em", color: "#444", textTransform: "uppercase", fontWeight: 600, marginBottom: 8 }}>Track A</p>
              <h3 style={{ fontFamily: serif, fontSize: isMobile ? 36 : 48, fontWeight: 300, fontStyle: "italic", color: "#000", lineHeight: 1, marginBottom: 4 }}>Frontier</h3>
              <p style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "#555", fontWeight: 400, marginBottom: 24, paddingBottom: 24, borderBottom: "0.5px solid rgba(0,0,0,.1)" }}>Commercial Market Venture</p>
              <p style={{ fontFamily: sans, fontSize: 13, fontWeight: 300, lineHeight: 1.85, color: "#444", marginBottom: 24 }}>Identify a real market opportunity, validate genuine customer demand, and build a scalable venture from the ground up. Teams move from idea to customer discovery to MVP to first traction — targeting customer acquisition, pre-orders, and first revenue before the Finale.</p>
              <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.3em", color: "#555", textTransform: "uppercase", marginBottom: 10 }}>Venture Types</p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 24 }}>
                {["AI Agent","SaaS Platform","Lifestyle Brand","Niche Media","Wellness App","Peer Marketplace","B2B Tool","Pet Wellness","Surf Brand"].map(t => (
                  <span key={t} style={{ fontFamily: sans, fontSize: 11, fontWeight: 300, color: "#555", border: "0.5px solid rgba(0,0,0,.15)", padding: "4px 10px", borderRadius: 20 }}>{t}</span>
                ))}
              </div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", background: "#F7F5F1", border: "0.5px solid rgba(0,0,0,.1)", fontFamily: sans, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#555", fontWeight: 500 }}>Judged by investors & executives</div>
            </div>
            {/* Track B - Vanguard */}
            <div style={{ background: "#0A0A0A", border: "0.5px solid rgba(199,171,117,.2)", padding: isMobile ? "32px 24px" : "44px 40px", position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "1px", background: `linear-gradient(90deg, transparent, ${gold}, transparent)` }} />
              <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.4em", color: gold, textTransform: "uppercase", fontWeight: 600, marginBottom: 8 }}>Track B</p>
              <h3 style={{ fontFamily: serif, fontSize: isMobile ? 36 : 48, fontWeight: 300, fontStyle: "italic", color: "#FBF7EE", lineHeight: 1, marginBottom: 4 }}>Vanguard</h3>
              <p style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: gold, fontWeight: 400, marginBottom: 24, paddingBottom: 24, borderBottom: "0.5px solid rgba(199,171,117,.15)" }}>Community Impact Venture</p>
              <p style={{ fontFamily: sans, fontSize: 13, fontWeight: 300, lineHeight: 1.85, color: "#FBF7EE", marginBottom: 24 }}>Identify a real problem affecting Orange County and build a venture with a viable business model to address it. Teams conduct field research, engage directly with the community, and pursue first customers, pilot commitments, and letters of support — presenting to investors, executives, and invited community officials on Finale day.</p>
              <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.3em", color: gold, textTransform: "uppercase", marginBottom: 10 }}>Community Problems</p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 24 }}>
                {["E-bike safety","Beach parking","Summer traffic","Surf access","Youth mental health","Senior isolation","Coastal wellness","Small business visibility","Youth sports access"].map(t => (
                  <span key={t} style={{ fontFamily: sans, fontSize: 11, fontWeight: 300, color: "#FBF7EE", border: "0.5px solid rgba(199,171,117,.2)", padding: "4px 10px", borderRadius: 20 }}>{t}</span>
                ))}
              </div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", background: "rgba(199,171,117,.08)", border: "0.5px solid rgba(199,171,117,.25)", fontFamily: sans, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: gold, fontWeight: 500 }}>★ Community Impact Award · Dual judging panel</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* PORTFOLIO */}
      <div style={{ background: "#fff", padding: isMobile ? "52px 24px" : "80px 80px", borderTop: "1px solid rgba(0,0,0,.06)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            <div style={{ width: 32, height: "1px", background: "rgba(139,105,20,.4)" }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 0, border: "0.5px solid rgba(0,0,0,.1)" }}>
            {[
              ["Customer Discovery Report","Documented interviews, survey findings, and market validation methodology"],
              ["Venture Brief & Business Model","Full written venture concept — problem, solution, market, revenue model, go-to-market"],
              ["Competitive Market Analysis","Landscape research with positioning and differentiation framework"],
              ["Traction Evidence","Documented signups, pre-orders, customer conversations, revenue, or pilot commitments"],
              ["Recorded Pitch","Professional recording of their Venture Finale presentation before a live panel"],
              ["Leadership Case Study","Written reflection on a real crisis scenario worked through during the program"],
              ["Letters of Recommendation","From lead faculty, invited specialists, and senior executives who worked with them throughout"],
              ["Certificate of Completion","Excalibur Academy Summer Intensive — formally issued, physically bound"],
            ].map(([title, desc], i) => (
              <div key={i} style={{ padding: "20px 24px", borderBottom: "0.5px solid rgba(0,0,0,.08)", borderRight: i % 2 === 0 ? "0.5px solid rgba(0,0,0,.08)" : "none", display: "flex", gap: 14, alignItems: "start" }}>
                <div style={{ width: 6, height: 6, borderRadius: "50%", background: gold, marginTop: 6, flexShrink: 0 }} />
                <div>
                  <p style={{ fontFamily: sans, fontSize: 13, fontWeight: 500, color: "#111", marginBottom: 4 }}>{title}</p>
                  <p style={{ fontFamily: sans, fontSize: 12, color: "#555", fontWeight: 300, lineHeight: 1.6 }}>{desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div style={{ background: "#000", padding: isMobile ? "52px 24px" : "72px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.45em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 12 }}>Portfolio &amp; Beyond</p>
          <h2 style={{ fontFamily: serif, fontSize: isMobile ? 26 : 40, fontWeight: 300, fontStyle: "italic", color: "#FBF7EE", lineHeight: 1.05, marginBottom: 12 }}>Program Completion Summary</h2>
          <p style={{ fontFamily: sans, fontSize: 14, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.85, marginBottom: 32, maxWidth: 760 }}>A formal summary of the student's venture work, leadership role, market validation, and final presentation before Excalibur faculty, executives, investors, and community leaders. Professional statement of what the student accomplished and can reference for college applications, résumés, interviews, and future opportunities.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ background: "rgba(255,255,255,.02)", border: "0.5px solid rgba(199,171,117,.15)", padding: isMobile ? "24px 20px" : "28px 32px" }}>
              <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.3em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 12 }}>Frontier · Commercial Market Venture</p>
              <p style={{ fontFamily: sans, fontSize: 13, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.85 }}>"Co-founded a venture at Excalibur Academy's Summer Intensive — identified a market opportunity, conducted customer discovery and validation, built an MVP, established first business relationships and a professional network, and generated early market traction including customer acquisition, signups, pre-orders, and first revenue. Presented a live business case to a panel of investors and executives. August 2026."</p>
            </div>
            <div style={{ background: "rgba(199,171,117,.04)", border: "0.5px solid rgba(199,171,117,.3)", padding: isMobile ? "24px 20px" : "28px 32px" }}>
              <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.3em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 12 }}>Vanguard · Community Impact Venture</p>
              <p style={{ fontFamily: sans, fontSize: 13, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.85 }}>"Identified a real problem in Orange County, built a venture to address it, conducted community testing and validation, secured first market traction — including pre-orders, signups, pilot commitments, and letters of support from local organizations and community stakeholders — and presented to city officials and a panel of investors and executives at Excalibur Academy's Venture Finale. August 2026."</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* A DAY AT EXCALIBUR */}
      <div style={{ padding: isMobile ? "52px 24px" : "72px 80px", background: "#FAF8F4", borderTop: "1px solid rgba(0,0,0,.07)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            <div style={{ width: 32, height: "1px", background: "rgba(139,105,20,.4)" }} />
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.4em", color: "#8B6914", fontWeight: 700, textTransform: "uppercase", margin: 0 }}>A Day at Excalibur</p>
          </div>
          ...
          <p style={{ fontFamily: sans, fontSize: 14, color: "#444", fontWeight: 300, lineHeight: 1.8, marginBottom: 32, maxWidth: 560 }}>Monday through Friday. 9:30 AM to 4:00 PM. Click any block to see what happens in that session.</p>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 2 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
              {dailySchedule.map((block, i) => (
                <React.Fragment key={i}>
                  <div onClick={() => setActiveDay(activeDay === i ? null : i)} style={{ display: "grid", gridTemplateColumns: "80px 1fr", gap: 12, padding: "14px 20px", background: activeDay === i ? "rgba(199,171,117,.12)" : "#fff", borderLeft: `3px solid ${activeDay === i ? gold : "transparent"}`, cursor: block.desc ? "pointer" : "default", transition: "all .15s", alignItems: "center" }}>
                    <span style={{ fontFamily: sans, fontSize: 10, color: "#8B6914", fontWeight: 700 }}>{block.time}</span>
                    <div>
                      <p style={{ fontFamily: sans, fontSize: 12, fontWeight: 600, color: activeDay === i ? "#000" : "#111", lineHeight: 1.3 }}>{block.block}</p>
                      <p style={{ fontFamily: sans, fontSize: 10, color: "#888", fontWeight: 300 }}>{block.dur}</p>
                    </div>
                  </div>
                  {/* Mobile: expand inline under each row */}
                  {isMobile && activeDay === i && block.desc && (
                    <div style={{ background: "#F5F3EE", padding: "20px 20px", borderLeft: `3px solid ${gold}` }}>
                      <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.3em", color: "#8B6914", fontWeight: 700, textTransform: "uppercase", marginBottom: 8 }}>{block.time} · {block.dur}</p>
                      <p style={{ fontFamily: serif, fontSize: 17, fontWeight: 600, color: "#111", lineHeight: 1.2, marginBottom: 10 }}>{block.block}</p>
                      {block.role && <p style={{ fontFamily: sans, fontSize: 11, color: "#8B6914", fontWeight: 600, letterSpacing: "0.08em", marginBottom: 12 }}>{block.role}</p>}
                      <p style={{ fontFamily: sans, fontSize: 13, lineHeight: 1.85, color: "#333", fontWeight: 300 }}>{block.desc}</p>
                    </div>
                  )}
                </React.Fragment>
              ))}
            ...
            {/* Desktop: side panel */}
            {!isMobile && (
              <div style={{ background: "#fff", minHeight: 300 }}>
                {activeDay !== null && dailySchedule[activeDay] && dailySchedule[activeDay].desc ? (
                  <div style={{ padding: "28px 28px" }}>
                    <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.3em", color: "#8B6914", fontWeight: 700, textTransform: "uppercase", marginBottom: 8 }}>{dailySchedule[activeDay].time} · {dailySchedule[activeDay].dur}</p>
                    <p style={{ fontFamily: serif, fontSize: 22, fontWeight: 600, color: "#111", lineHeight: 1.2, marginBottom: 12 }}>{dailySchedule[activeDay].block}</p>
                    {dailySchedule[activeDay].role && <p style={{ fontFamily: sans, fontSize: 11, color: "#8B6914", fontWeight: 600, letterSpacing: "0.08em", marginBottom: 14 }}>{dailySchedule[activeDay].role}</p>}
                    <p style={{ fontFamily: sans, fontSize: 13, lineHeight: 1.85, color: "#333", fontWeight: 300 }}>{dailySchedule[activeDay].desc}</p>
                  </div>
                ) : (
                  <div style={{ padding: "36px 40px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 300, gap: 12 }}>
                    <span style={{ fontFamily: serif, fontSize: 36, color: "rgba(0,0,0,.08)" }}>✦</span>
                    <p style={{ fontFamily: serif, fontSize: 15, color: "rgba(0,0,0,.25)", fontStyle: "italic", textAlign: "center" }}>Select a time block<br />to see what happens in that session</p>
                  </div>
                )}
              </div>
            )}
      ...
      <div style={{ background: "#050505", padding: isMobile ? "52px 24px" : "72px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            <div style={{ width: 32, height: "1px", background: `linear-gradient(90deg, ${gold}, transparent)` }} />
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.45em", color: gold, fontWeight: 600, textTransform: "uppercase", margin: 0 }}>Summer Program Schedule</p>
          </div>
          <h2 style={{ fontFamily: serif, fontSize: isMobile ? 26 : 38, fontWeight: 300, fontStyle: "italic", color: "#FBF7EE", lineHeight: 1.05, marginBottom: 8 }}>Excalibur Venture &amp; Leadership Launchpad</h2>
          <p style={{ fontFamily: sans, fontSize: 14, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.8, marginBottom: 32, maxWidth: 560 }}>Monday July 27 – Friday August 7, 2026 · Venture Finale Saturday August 8, 2026</p>
          <div style={{ background: "#0A0A0A", border: "0.5px solid rgba(199,171,117,.15)", padding: "24px 28px", marginBottom: 40, display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4,1fr)", gap: isMobile ? 20 : 24 }}>
            {[["Public Speaking","90 min · Daily"],["Specialist Workshop","60 min · Daily"],["Venture Workshop","2.5 hrs · Daily"],["Guest Speakers","Renowned guest speakers from different industries"]].map(([l,v]) => (
              <div key={l}>
                <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.3em", color: gold, textTransform: "uppercase", marginBottom: 6 }}>{l}</p>
                <p style={{ fontFamily: sans, fontSize: 13, fontWeight: 500, color: "#FBF7EE" }}>{v}</p>
              </div>
            ))}
          </div>
          {/* Week headers */}
          {[{week:"I",label:"Foundation, Validation & Market Discovery",dates:"July 27 – July 31",daysSlice:[0,5]},{week:"II",label:"Execution, Pitching & The Venture Finale",dates:"August 3 – August 7",daysSlice:[5,10]}].map(({week,label,dates,daysSlice}) => (
            <div key={week} style={{ marginBottom: 32 }}>
              <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "80px 1fr", gap: 20, alignItems: "center", padding: "24px 28px", background: "#0A0A0A", borderTop: `1px solid rgba(199,171,117,.15)`, marginBottom: 2 }}>
                <span style={{ fontFamily: serif, fontSize: 52, fontWeight: 300, fontStyle: "italic", color: gold, lineHeight: 1 }}>{week}</span>
                <div>
                  <p style={{ fontFamily: serif, fontSize: isMobile ? 17 : 22, fontWeight: 400, color: "#FBF7EE", marginBottom: 4 }}>{label}</p>
                  <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.3em", color: "#C7AB75", textTransform: "uppercase" }}>{dates}</p>
                </div>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 1 }}>
                {days.slice(daysSlice[0], daysSlice[1]).map((d, i) => (
                  <div key={i} style={{ background: "#080808", padding: isMobile ? "18px 20px" : "20px 28px", borderLeft: `2px solid ${d.speaker ? gold : "rgba(199,171,117,.15)"}`, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "120px 1fr auto", gap: isMobile ? 8 : 24, alignItems: "center" }}>
                    <div>
                      <p style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.25em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 3 }}>{d.n}</p>
                      <p style={{ fontFamily: sans, fontSize: 10, color: "#C7AB75", fontWeight: 300 }}>{d.date}</p>
                    </div>
                    <div>
                      <p style={{ fontFamily: serif, fontSize: isMobile ? 15 : 18, fontWeight: 400, color: "#FBF7EE", lineHeight: 1.2, marginBottom: 4 }}>{d.title}</p>
                      <p style={{ fontFamily: sans, fontSize: 11, color: "#C7AB75", fontStyle: "italic", fontWeight: 300 }}>"{d.theme}"</p>
                    </div>
                    {d.speaker && !isMobile && (
                      <span style={{ fontFamily: eyebrow_font, fontSize: 8, letterSpacing: "0.15em", color: gold, border: `1px solid rgba(199,171,117,.3)`, padding: "4px 10px", textTransform: "uppercase", whiteSpace: "nowrap" }}>Guest Speaker</span>
                    )}
                  </div>
                ))}
              </div>
      ...
      {/* VENTURE FINALE */}
      <div style={{ background: "#0A0A0A", padding: isMobile ? "52px 24px" : "80px 80px", borderTop: `1px solid rgba(199,171,117,.15)` }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 72, alignItems: "center" }}>
          <div>
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.4em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 14 }}>The Culmination · Saturday August 8, 2026</p>
            <h3 style={{ fontFamily: serif, fontSize: isMobile ? 28 : 44, fontWeight: 300, fontStyle: "italic", color: "#FBF7EE", lineHeight: 1.05, marginBottom: 20 }}>Excalibur<br />Venture Finale.</h3>
            <p style={{ fontFamily: sans, fontSize: 13, lineHeight: 1.9, color: "#FBF7EE", fontWeight: 300, marginBottom: 20 }}>The Venture Finale takes place at a private South Orange County estate, where families gather alongside investors, executives, entrepreneurs, and community leaders. One by one, each team takes the floor to present what they have built — ten days of research, strategy, execution, and growth, defended before people who understand what real leadership and enterprise require.</p>
            <p style={{ fontFamily: sans, fontSize: 13, lineHeight: 1.9, color: "#FBF7EE", fontWeight: 300 }}>Teams are evaluated on concept strength, market research, customer insight, marketing strategy, business logic, and composure under questioning. Vanguard track teams are additionally evaluated by invited community officials.</p>
          </div>
          <div>
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.35em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 16 }}>Seven Awards</p>
            {[
              ...
              ["Most Innovative","Most original approach to a problem — commercial or community."],
              ["Best Leadership","Team that demonstrated the strongest leadership, accountability, and execution discipline."],
              ["Highest Market Validation","Most documented evidence of real demand — signups, pre-orders, customer conversations, revenue, or pilot commitments."],
              ["Audience Choice","Voted by families, guests, and community members in attendance at the Finale."],
              ["★ Community Impact Award","Vanguard Track — Jointly judged by investors and invited community officials. Double weight on Market Validation scoring."],
            ].map(([name, desc]) => (
              <div key={name} style={{ padding: "12px 0", borderBottom: "1px solid rgba(199,171,117,.07)" }}>
                <p style={{ fontFamily: sans, fontSize: 12, fontWeight: 600, color: gold, marginBottom: 3 }}>{name}</p>
                <p style={{ fontFamily: sans, fontSize: 11, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.6 }}>{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ background: "#F5F3EE", padding: isMobile ? "52px 24px" : "80px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            <div style={{ width: 32, height: "1px", background: "rgba(139,105,20,.4)" }} />
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.45em", color: "#8B6914", fontWeight: 600, textTransform: "uppercase", margin: 0 }}>Team Assembly</p>
          </div>
          <h2 style={{ fontFamily: serif, fontSize: isMobile ? 26 : 40, fontWeight: 300, fontStyle: "italic", color: "#000", lineHeight: 1.05, marginBottom: 12 }}>Teams curated<br />before the program begins.</h2>
          <p style={{ fontFamily: sans, fontSize: 14, color: "#444", fontWeight: 300, lineHeight: 1.8, marginBottom: 40, maxWidth: 640 }}>Teams are curated before the program begins — aligned by track, balanced by skill set and chosen tracks — commercial or community venture. Students arrive on Day 1 already placed with their venture team, allowing the program to move immediately into leadership dynamics, role definition, collaboration, and execution.</p>
          <div style={{ marginBottom: 32 }}>
            {[
              {n:"1",title:"Applications reviewed",body:"The Excalibur faculty team reviews every application and assembles teams of 4–5 students — balanced across track preference, skill profile, industry interest, and school. Every team has a natural mix of leadership, analytical, creative, communication, and technical strengths."},
              {n:"2",title:"Teams confirmed before arrival",body:"Each student receives their team assignment in advance. On Day 1, a welcome folder is waiting at their seat — team number, track designation, and the names of every team member. Lead faculty formally open the program and introduce all teams."},
              {n:"3",title:"Roles assigned by the team on Day 1",body:"During the Day 1 team building session, students assign roles among themselves. Every student leaves Day 1 with a defined role — CEO, CMO, CFO, CPO, or CSO. That role appears on their Excalibur Academy business card, issued after the Day 3 branding session."},
            ].map((s) => (
              <div key={s.n} style={{ display: "grid", gridTemplateColumns: "40px 1fr", gap: 20, padding: "24px 0", borderBottom: "0.5px solid rgba(0,0,0,.1)", alignItems: "start" }}>
                <div style={{ width: 34, height: 34, border: "0.5px solid rgba(199,171,117,.3)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <span style={{ fontFamily: sans, fontSize: 12, fontWeight: 500, color: "#8B6914" }}>{s.n}</span>
                </div>
                <div>
                  <p style={{ fontFamily: sans, fontSize: 14, fontWeight: 500, color: "#111", marginBottom: 6 }}>{s.title}</p>
                  <p style={{ fontFamily: sans, fontSize: 13, color: "#444", fontWeight: 300, lineHeight: 1.8 }}>{s.body}</p>
                </div>
              </div>
            ))}
          </div>
          <div>
            <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.35em", color: "#8B6914", textTransform: "uppercase", fontWeight: 600, marginBottom: 16 }}>Team Roles</p>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : "repeat(5,1fr)", gap: 10 }}>
              {[["CEO","Team lead. Direction and decisions."],["CMO","Marketing, brand, outreach."],["CFO","Financials, pricing, revenue."],["CPO","Product, prototype, delivery."],["CSO","Sales, customers, traction."]].map(([role,desc]) => (
                <div key={role} style={{ padding: "18px 14px", border: "0.5px solid rgba(0,0,0,.12)", textAlign: "center" }}>
                  <p style={{ fontFamily: serif, fontSize: 18, fontWeight: 600, color: "#000", marginBottom: 6 }}>{role}</p>
                  <p style={{ fontFamily: sans, fontSize: 11, color: "#555", fontWeight: 300, lineHeight: 1.5 }}>{desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div style={{ background: "#000", padding: isMobile ? "52px 24px" : "72px 80px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 48 : 80 }}>
          <div>
            ...
            {["Daily public speaking and executive communication training","Venture development — market research, competitor analysis, business planning","Marketing strategy, branding, and customer psychology","AI tools for business research, analysis, and presentation","Sales, persuasion, and pitch training","Distinguished guest speakers from different industry sectors, business and entrepreneurship","Excalibur Venture Finale — live Shark Tank-inspired pitch before real investors, entrepreneurs, and executives","Bound Certificate of Completion and Graduate Portfolio","Catered daily lunches, snacks, smoothies and refreshments","Priority consideration for the Ten-Month Flagship Program","Daily Academy Shuttle for pick up/drop off (for South OC students)"].map((item, i) => (
              <div key={i} style={{ display: "flex", gap: 12, padding: "9px 0", borderBottom: "1px solid rgba(199,171,117,.06)", alignItems: "flex-start" }}>
                <span style={{ fontFamily: serif, fontSize: 10, color: gold, flexShrink: 0, paddingTop: 1 }}>—</span>
          ...
          <div>
            ...
            <p style={{ fontFamily: sans, fontSize: 14, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.85 }}>We look for curiosity, maturity, and a genuine interest in business, leadership, and how the world actually works. The student who leans forward, asks questions, and is ready to step outside their comfort zone.</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: "#FAFAF8", padding: isMobile ? "52px 24px" : "72px 80px", borderTop: "1px solid rgba(0,0,0,.06)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: serif, fontSize: isMobile ? 26 : 38, fontWeight: 600, color: "#000", lineHeight: 1.05, marginBottom: 52 }}>How to Apply</h2>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", position: "relative", marginBottom: 0 }}>
            {!isMobile && <div style={{ position: "absolute", top: 22, left: 44, right: 44, height: "1px", background: "linear-gradient(90deg, rgba(0,0,0,.04), rgba(0,0,0,.15), rgba(0,0,0,.04))", zIndex: 0 }} />}
            {[
              {n:"01",title:"Submit Application",desc:"Begin by submitting a brief application for admissions review using the form below. Excalibur is selective, and each applicant is considered individually."},
              {n:"02",title:"Admissions Consultation",desc:"A member of the admissions team will contact the family within 24 hours to answer questions, discuss the student's goals, and walk through program options and availability."},
              {n:"03",title:"Enrollment Confirmation",desc:"Upon acceptance, enrollment is confirmed by deposit. Each cohort is limited to 20 students to preserve the quality of instruction, mentorship, and direct feedback."},
            ].map((step) => (
              <div key={step.n} style={{ padding: isMobile ? "28px 0" : "0 28px 0 0", borderTop: isMobile ? "1px solid rgba(199,171,117,.1)" : "none", borderLeft: !isMobile && step.n !== "01" ? "1px solid rgba(199,171,117,.1)" : "none", paddingLeft: !isMobile && step.n !== "01" ? 28 : 0, position: "relative", zIndex: 1 }}>
                <div style={{ width: 44, height: 44, border: "1px solid rgba(0,0,0,.2)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 24, background: "#FAFAF8" }}>
                  <span style={{ fontFamily: serif, fontSize: 18, fontWeight: 300, color: "#8B6914" }}>{step.n}</span>
                </div>
                <p style={{ fontFamily: serif, fontSize: isMobile ? 16 : 17, fontWeight: 600, color: "#000", lineHeight: 1.25, marginBottom: 12 }}>{step.title}</p>
      ...
      <div style={{ background: "#050505", padding: isMobile ? "52px 24px" : "72px 80px", borderTop: "1px solid rgba(199,171,117,.1)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.4em", color: gold, fontWeight: 600, textTransform: "uppercase", marginBottom: 16 }}>Enrollment · Summer 2026</p>
          <h2 style={{ fontFamily: serif, fontSize: isMobile ? 28 : 40, fontWeight: 600, color: "#FBF7EE", lineHeight: 1.05, marginBottom: 8 }}>Apply for Summer 2026</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 2, background: "#111", marginBottom: 2 }}>
            {[{label:"WAVE — JULY 27",wave:"Wave",dates:"July 27 – August 8, 2026",days:"Monday – Friday · 9:30 AM – 4:00 PM",tag:"● Enrollment Open",tagColor:"#4DB87A"}].map((w, i) => (
              <div key={i} style={{ background: "#080808", padding: isMobile ? "36px 24px" : "48px 44px", borderTop: `2px solid ${gold}` }}>
                ...
                {[["Schedule","Mon–Fri · 9:30 AM–4:00 PM · Venture Finale Saturday Aug 8"],["Duration","Two Weeks · 10 Full Days"],["Class Size","Limited to 20 students"],["Tuition","$410 / full day · $4,500 per wave"],["Includes","Catered lunches · Guest speakers · Venture workshops · Shark Tank Finale"]].map(([k,v]) => (
            ...
            <div style={{ background: "#050505", padding: isMobile ? "36px 24px" : "48px 44px", borderTop: "2px solid rgba(199,171,117,.15)", display: "flex", flexDirection: "column", justifyContent: "center", gap: 20 }}>
              <p style={{ fontFamily: serif, fontSize: 52, fontWeight: 300, color: "#FBF7EE", lineHeight: 1 }}>$4,500</p>
              <p style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.25em", color: gold, textTransform: "uppercase" }}>One Wave · Limited to 20 Students</p>
              <div style={{ height: "1px", background: "rgba(199,171,117,.1)" }} />
              <div>
                {[["Program Dates","July 27 – August 7, 2026"],["Venture Finale","Saturday August 8, 2026"],["Tuition","$4,500 per wave"]].map(([k,v]) => (
                  <div key={k} style={{ display: "flex", gap: 16, padding: "10px 0", borderBottom: "1px solid rgba(199,171,117,.06)" }}>
                    <span style={{ fontFamily: eyebrow_font, fontSize: 9, letterSpacing: "0.15em", color: "#C7AB75", minWidth: 100, flexShrink: 0 }}>{k}</span>
                    <span style={{ fontFamily: sans, fontSize: 12, color: "#FBF7EE", fontWeight: 300 }}>{v}</span>
                  </div>
                ))}
              </div>
      ...
      <div style={{ background: "#000", padding: isMobile ? "52px 24px" : "72px 80px", borderTop: "1px solid rgba(199,171,117,.1)" }}>
        <div style={{ maxWidth: 740, margin: "0 auto" }}>
          ...
          <div style={{ background: "#080808", borderTop: `2px solid ${gold}`, padding: "36px 32px" }}>
            ...
            <input type="text" placeholder="Preferred Track (Frontier — Commercial or Vanguard — Community Impact)" style={{ background: "#000", border: "1px solid rgba(199,171,117,.2)", color: "#FBF7EE", padding: "13px 16px", fontFamily: "'Avenir','Avenir Next','Century Gothic',sans-serif", fontSize: 13, fontWeight: 300, outline: "none", width: "100%", marginBottom: 24 }} />
...
function ApplicationPage({ setPage, defaultProgram }) {
  ...
  const programs = [
    { id: "summer", label: "SUMMER INTENSIVE", title: "Summer Intensive", price: "$4,500 per wave", dates: "July 27 – August 8, 2026 · Finale Saturday Aug 8", desc: "July 27 – August 8. Full days, Monday through Friday, led by senior faculty, Wall Street executives, successful entrepreneurs, and distinguished guest speakers. The wave culminates in a Shark Tank-inspired Venture finale before real investors, community leaders and families.", page: "summer-detail" },
    { id: "six-week", label: "SIX-WEEK INTENSIVE", title: "Six-Week Intensive", price: "$3,900 per wave", dates: "Four waves — Fall, Winter, Spring, Summer", desc: "Offered in four waves annually, the Six-Week Intensive distills the complete Excalibur curriculum into a focused, high‑impact experience. Six weeks in duration. One core discipline per week.", page: "intensive" },
    { id: "flagship", label: "TEN-MONTH FLAGSHIP", title: "Flagship Formation Program", price: "From $1,900 / month", dates: "September 2026 – June 2027", desc: "The Full Formation is Excalibur's ten-month flagship — a deep, immersive course of study for students ready for complete entrepreneurial, intellectual, and personal formation across all modules, ten industry sectors, and real-world applied engagements.", page: "flagship-detail" },
  ];
  const waves = [
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", borderLeft: "1px solid rgba(199,171,117,.08)" }}>
          {[
            ...
            <div key={label} style={{ padding: isMobile ? "32px 24px" : "44px 52px", borderRight: "1px solid rgba(199,171,117,.08)", borderBottom: isMobile ? "1px solid rgba(199,171,117,.08)" : "none" }}>
              ...
              <p style={{ fontFamily: sans, fontSize: 13, color: "#FBF7EE", fontWeight: 300, lineHeight: 1.7 }}>{desc}</p>
            </div>
          ))}
        </div>
      </div>
