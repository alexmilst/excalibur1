  ...
  const programs = [
    {
      ...
      details: [
        ...
        ["Tuition", "$225 / day · $4,500 per wave"],
            ...
            {[
              {
                ...
                price: "$225 / day", period: "· $4,500 per wave",
      ...
      <div style={{ background: "#000", padding: isMobile ? "60px 24px" : "80px 80px", borderTop: "1px solid rgba(199,171,117,.1)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap: 0 }}>
            {[
              { label: "Summer Intensive", price: "$225", period: "per day · $4,500 per wave", detail: "Two waves — July & August 2026.\n20 students per wave." },
            ...
            <div style={{ background: "#080808", borderTop: `2px solid rgba(199,171,117,.35)`, marginBottom: 2, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1px 1fr 1px 1fr", overflow: "hidden" }}>
              ...
              <div style={{ padding: isMobile ? "0 28px 40px" : "52px 52px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <div>
                  ...
                  <div style={{ fontFamily: serif, fontSize: 38, color: "#FBF7EE", fontWeight: 600, lineHeight: 1, marginBottom: 2 }}>$225<span style={{ fontSize: 18, fontWeight: 300 }}> / day</span></div>
                  <div style={{ fontFamily: sans, fontSize: 12, color: gold, fontWeight: 300, marginBottom: 8 }}>$4,500 · Two-Week Wave</div>
    ...
    <div style={{ background: "#000", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: isMobile ? "48px 24px" : "80px 40px", textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap: 2, background: "#111", marginBottom: 52, width: "100%", maxWidth: 880 }}>
          {[
            { label: "SUMMER INTENSIVE", dates: "July & August 2026", detail: "Mon–Fri · 9:30 AM–3:00 PM · $225/day · $4,500 per wave" },
...
function FlagshipEnrollSelector({ openInquiry, isMobile }) {
  ...
  const programs = [
    ...
    { id: "summer", label: "SUMMER INTENSIVE", title: "Summer Intensive", price: "$225 / day · $4,500 per wave", desc: "Two weeks, full days. All eight disciplines with daily guest speakers and a Venture Finale." },
  ];
  const tracks = [
      ...
      <div style={{ background: "#000", padding: isMobile ? "52px 24px" : "72px 80px", borderTop: "1px solid rgba(199,171,117,.1)", borderBottom: "1px solid rgba(199,171,117,.1)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 48 : 80 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: serif, fontSize: isMobile ? 48 : 64, fontWeight: 300, color: "#FBF7EE", lineHeight: 1, letterSpacing: "-0.02em", marginBottom: 4 }}>$225<span style={{ fontSize: isMobile ? 22 : 28, fontWeight: 300 }}> / day</span></div>
            <div style={{ fontFamily: sans, fontSize: 14, color: gold, fontWeight: 300, marginBottom: 24 }}>$4,500 · Two-Week Wave</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 2, background: "#111", marginBottom: 2 }}>
            {[
              ...
              <div key={i} style={{ background: "#080808", padding: isMobile ? "36px 24px" : "48px 44px", borderTop: `2px solid ${gold}` }}>
                ...
                {[["Schedule", w.days], ["Duration", "Two weeks · 10 sessions"], ["Class Size", "20 students maximum"], ["Tuition", "$225 / day · $4,500 per wave"], ["Includes", "Catered lunches · Guest speakers · War Room · Finale"]].map(([k, v]) => (
    ...
    <div style={{ background: "#000", paddingTop: 0 }}>
      ...
      <div style={{ background: "#050505", padding: isMobile ? "52px 24px" : "72px 80px", borderBottom: "1px solid rgba(199,171,117,.08)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(4,1fr)", gap: 0 }}>
            {[
              { n: "01", title: "Cocktail Reception", desc: "An intimate welcome reception on the estate grounds. Families are introduced to the Excalibur team, faculty, and one another in a relaxed, private setting." },
...
function ApplicationPage({ setPage, defaultProgram }) {
  ...
  const programs = [
    { id: "summer", label: "SUMMER INTENSIVE", title: "Summer Intensive", price: "$225 / day · $4,500 per wave", desc: "Two weeks, full days, Mon–Fri. For students aged 15–17 (rising juniors and seniors). Public speaking, business, AI, sales and a Shark Tank–style Venture Court finale. 20 students per wave.", page: "summer-detail" },
