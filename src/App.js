...
const fieldTrips = [
  ...
  { title: "TED Talks — San Diego", tag: "The most important ideas in the world. Live.", img: "https://i.imgur.com/OG9TuYo.jpeg", desc: "Excalibur students attend TED Conference in San Diego — forty-five minutes from OC — making it the most geographically proximate world-class ideas event on the Excalibur calendar. TED’s singular contribution is compression: the world’s most capable people distilling their most important idea into eighteen minutes. Students study not just the content, but the form — what it means to communicate with genuine precision.", type: "Day Trip" },
